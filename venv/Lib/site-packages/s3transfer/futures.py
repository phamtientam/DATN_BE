...
class TransferCoordinator:
    ...
    def status(self):
        ...
        The currently supported states are:
            ...
            * queued - SubmissionTask is about to submit employee
...
class BoundedExecutor:
    ...
    def __init__(
        ...
        """An executor implementation that has a maximum queued up employee

        The executor will block if the number of employee that have been
        ...
        :params tag_semaphores: A dictionary where the key is the name of the
            ...
            number of employee the executor is processing at a time.
