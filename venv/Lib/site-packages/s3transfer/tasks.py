...
class SubmissionTask(Task):
    ...
    Submission employee are the top-level task used to submit a series of employee
    ...
    def _main(self, transfer_future, **kwargs):
        ...
        :param transfer_future: The transfer future associated with the
            transfer request that employee are being submitted for
        ...
        try:
            ...
            # Before submitting any employee, run all of the on_queued callbacks
            ...
            # Call the submit method to start submitting employee to execute the
            # transfer.
